  ...
  class Admin::BulletinsController < Admin::ApplicationController
    ...
    def publish
      ...
      unless @bulletin.may_publish?
        redirect_back fallback_location: admin_root_path, alert: t('alerts.admin.bulletin_publish_error')
      end
    ...
    def reject
      ...
      unless @bulletin.may_reject?
        redirect_back fallback_location: admin_root_path, alert: t('alerts.admin.bulletin_reject_error')
      end
    ...
    def archive
      ...
      unless @bulletin.may_archive?
        redirect_back fallback_location: admin_root_path, alert: t('alerts.admin.bulletin_archive_error')
      end
